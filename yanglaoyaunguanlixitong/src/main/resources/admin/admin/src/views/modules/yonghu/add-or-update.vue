               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="护工编号" prop="yonghuUuidNumber">
                       <el-input v-model="ruleForm.yonghuUuidNumber"
                                 placeholder="护工编号" clearable  :readonly="ro.yonghuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="护工姓名" prop="yonghuName">
                       <el-input v-model="ruleForm.yonghuName"
                                 placeholder="护工姓名" clearable  :readonly="ro.yonghuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="护工手机号" prop="yonghuPhone">
                       <el-input v-model="ruleForm.yonghuPhone"
                                 placeholder="护工手机号" clearable  :readonly="ro.yonghuPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="护工身份证号" prop="yonghuIdNumber">
                       <el-input v-model="ruleForm.yonghuIdNumber"
                                 placeholder="护工身份证号" clearable  :readonly="ro.yonghuIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="护工等级" prop="yonghuTypes">
                        <el-select v-model="ruleForm.yonghuTypes" :disabled="ro.yonghuTypes" placeholder="请选择护工等级">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="价钱" prop="yonghuJaiwei">
                       <el-input v-model="ruleForm.yonghuJaiwei"
                                 placeholder="价钱" clearable  :readonly="ro.yonghuJaiwei"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="护工邮箱" prop="yonghuEmail">
                       <el-input v-model="ruleForm.yonghuEmail"
                                 placeholder="护工邮箱" clearable  :readonly="ro.yonghuEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuPhoto: [
                              { required: true, message: '护工头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   yonghuTypes: [
                              { required: true, message: '护工等级不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   yonghuEmail: [
                              { required: true, message: '护工邮箱不能为空', trigger: 'blur' },
