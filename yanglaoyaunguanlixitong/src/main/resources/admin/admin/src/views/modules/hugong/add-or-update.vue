    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="hugongUuidNumber">
                       <el-input v-model="ruleForm.hugongUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.hugongUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="hugongUuidNumber">
                           <el-input v-model="ruleForm.hugongUuidNumber"
            ...
            <input id="laorenId" name="laorenId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报名理由" prop="hugongText">
                        <el-input type="textarea"  :readonly="ro.hugongText" v-model="ruleForm.hugongText" placeholder="报名理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.hugongText" label="报名理由" prop="hugongText">
                            <span v-html="ruleForm.hugongText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.hugongYesnoTypes" label="报名状态" prop="hugongYesnoTypes">
                        <el-input v-model="ruleForm.hugongYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.hugongYesnoText" label="审核回复" prop="hugongYesnoText">
                        <span v-html="ruleForm.hugongYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.hugongShenheTime" label="审核时间" prop="hugongShenheTime">
                        <span v-html="ruleForm.hugongShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    hugongUuidNumber: new Date().getTime(),
                    jiashuId: '',
                    laorenId: '',
                    hugongText: '',
                    insertTime: '',
                ...
                rules: {
                   ...
                   insertTime: [
                              { required: true, message: '护工更换申请时间不能为空', trigger: 'blur' },
                          ],
                   hugongYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=hugong_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.hugongYesnoTypesOptions = data.data.list;
                    }
                });
