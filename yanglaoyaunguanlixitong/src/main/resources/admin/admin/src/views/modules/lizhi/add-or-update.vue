    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="lizhiUuidNumber">
                       <el-input v-model="ruleForm.lizhiUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.lizhiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="lizhiUuidNumber">
                           <el-input v-model="ruleForm.lizhiUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报名理由" prop="lizhiText">
                        <el-input type="textarea"  :readonly="ro.lizhiText" v-model="ruleForm.lizhiText" placeholder="报名理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.lizhiText" label="报名理由" prop="lizhiText">
                            <span v-html="ruleForm.lizhiText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.lizhiYesnoTypes" label="报名状态" prop="lizhiYesnoTypes">
                        <el-input v-model="ruleForm.lizhiYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.lizhiYesnoText" label="审核回复" prop="lizhiYesnoText">
                        <span v-html="ruleForm.lizhiYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.lizhiShenheTime" label="审核时间" prop="lizhiShenheTime">
                        <span v-html="ruleForm.lizhiShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    lizhiUuidNumber: new Date().getTime(),
                    yonghuId: '',
                    lizhiText: '',
                    insertTime: '',
                    lizhiYesnoTypes: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=lizhi_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.lizhiYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`lizhi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.lizhiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
