               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="家属编号" prop="jiashuUuidNumber">
                       <el-input v-model="ruleForm.jiashuUuidNumber"
                                 placeholder="家属编号" clearable  :readonly="ro.jiashuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="家属姓名" prop="jiashuName">
                       <el-input v-model="ruleForm.jiashuName"
                                 placeholder="家属姓名" clearable  :readonly="ro.jiashuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="家属手机号" prop="jiashuPhone">
                       <el-input v-model="ruleForm.jiashuPhone"
                                 placeholder="家属手机号" clearable  :readonly="ro.jiashuPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="家属身份证号" prop="jiashuIdNumber">
                       <el-input v-model="ruleForm.jiashuIdNumber"
                                 placeholder="家属身份证号" clearable  :readonly="ro.jiashuIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="家属邮箱" prop="jiashuEmail">
                       <el-input v-model="ruleForm.jiashuEmail"
                                 placeholder="家属邮箱" clearable  :readonly="ro.jiashuEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                ruleForm: {
                    username: '',
                    password: '',
                    jiashuUuidNumber: new Date().getTime(),
                    jiashuName: '',
                    jiashuPhone: '',
                    jiashuIdNumber: '',
                    jiashuPhoto: '',
                ...
                rules: {
                   ...
                   jiashuPhone: [
                              {  required: true, message: '家属手机号不能为空', trigger: 'blur' },
                   ...
                   jiashuIdNumber: [
                              { required: true, message: '家属身份证号不能为空', trigger: 'blur' },
                   ...
                   jiashuPhoto: [
                              { required: true, message: '家属头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   jiashuEmail: [
                              { required: true, message: '家属邮箱不能为空', trigger: 'blur' },
