                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yanglaoyaunguanlixitong/upload/chuangweiMuBan.xls"
                        >批量导入床位数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('chuangwei','导入导出')"
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            form:{
                ...
                fangjianId : null,
                chuangweiName : null,
                chuangweiUuidNumber : null,
                chuangweiPhoto : null,
                chuangweiAddress : null,
                chuangweiTypes : null,
                chuangweiContent : null,
                chuangweiDelete : null,
                insertTime : null,
                createTime : null,
            },
            dataList: [],
