    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报名理由" prop="qingjiaText">
                        <el-input type="textarea"  :readonly="ro.qingjiaText" v-model="ruleForm.qingjiaText" placeholder="报名理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.qingjiaText" label="报名理由" prop="qingjiaText">
