        ...
        <el-form
            ...
            <input id="jiashuId" name="jiashuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="老人姓名" prop="laorenName">
                       <el-input v-model="ruleForm.laorenName"
                                 placeholder="老人姓名" clearable  :readonly="ro.laorenName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="老人手机号" prop="laorenPhone">
                       <el-input v-model="ruleForm.laorenPhone"
                                 placeholder="老人手机号" clearable  :readonly="ro.laorenPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="老人身份证号" prop="laorenIdNumber">
                       <el-input v-model="ruleForm.laorenIdNumber"
                                 placeholder="老人身份证号" clearable  :readonly="ro.laorenIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.laorenPhoto" label="老人照片" prop="laorenPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.laorenPhoto?$base.url+ruleForm.laorenPhoto:''"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.laorenContent"  label="老人描述" prop="laorenContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.laorenContent" label="老人描述" prop="laorenContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   laorenContent: [
                              { required: true, message: '老人描述不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
