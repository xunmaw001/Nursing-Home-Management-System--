            ...
            <div class="login-form">
                ...
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="家属编号" class="input" v-if="tableName=='jiashu'">
                                <el-input v-model="ruleForm.jiashuUuidNumber" autocomplete="off" placeholder="家属编号"  />
                           </el-form-item>
                        -->
                        <el-form-item label="家属姓名" class="input" v-if="tableName=='jiashu'">
                            <el-input v-model="ruleForm.jiashuName" autocomplete="off" placeholder="家属姓名"  />
                        </el-form-item>
                        <el-form-item label="家属手机号" class="input" v-if="tableName=='jiashu'">
                            <el-input v-model="ruleForm.jiashuPhone" autocomplete="off" placeholder="家属手机号"  />
                        </el-form-item>
                        <el-form-item label="家属身份证号" class="input" v-if="tableName=='jiashu'">
                            <el-input v-model="ruleForm.jiashuIdNumber" autocomplete="off" placeholder="家属身份证号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="jiashuPhotoFlag">
                            </el-form-item>
                            <el-form-item label="家属头像" class="input" v-if="tableName=='jiashu'">
                                    <file-upload
                                        tip="点击上传家属头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="家属邮箱" class="input" v-if="tableName=='jiashu'">
                            <el-input v-model="ruleForm.jiashuEmail" autocomplete="off" placeholder="家属邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='jiashu'">
                                <el-input v-model="ruleForm.createTime" autocomplete="off" placeholder="创建时间"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="护工编号" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuUuidNumber" autocomplete="off" placeholder="护工编号"  />
                           </el-form-item>
                        -->
                        <el-form-item label="护工姓名" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="护工姓名"  />
                        </el-form-item>
                        <el-form-item label="护工手机号" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuPhone" autocomplete="off" placeholder="护工手机号"  />
                        </el-form-item>
                        <el-form-item label="护工身份证号" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuIdNumber" autocomplete="off" placeholder="护工身份证号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="yonghuPhotoFlag">
                            </el-form-item>
                            <el-form-item label="护工头像" class="input" v-if="tableName=='yonghu'">
                                    <file-upload
                                        tip="点击上传护工头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                       <!--<el-form-item class="input" label="护工等级">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.yonghuTypes" placeholder="请选择护工等级">
                                <el-option
                        ...
                        <!--
                            <el-form-item label="价钱" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuJaiwei" autocomplete="off" placeholder="价钱"  />
                           </el-form-item>
                        -->
                        <el-form-item label="护工邮箱" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuEmail" autocomplete="off" placeholder="护工邮箱"  />
                        </el-form-item>
    ...
    export default {
        data() {
            return {
                ...
                rules: {},
                sexTypesOptions : [],
                jiashuPhotoFlag:false,//用于刷新文件上传
        ...
        methods: {
            ...
            jiashuPhotoUploadChange(fileUrls) {
               this.ruleForm.jiashuPhoto = fileUrls;
                if(this.jiashuPhotoFlag){
                    this.jiashuPhotoFlag=false;
                }else{
                    this.jiashuPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            // jiashu 中的 家属编号 判空处理
                            // if('jiashu' == this.tableName && (this.ruleForm.jiashuUuidNumber== null ||this.ruleForm.jiashuUuidNumber== "")){
                            ...
                            if((!this.ruleForm.jiashuIdNumber)&& 'jiashu'==this.tableName){
                                this.$message.error('家属身份证号不能为空');
                                return
                            }
                            // jiashu 中的 家属头像 判空处理
                            // if('jiashu' == this.tableName && (this.ruleForm.jiashuPhoto== null ||this.ruleForm.jiashuPhoto== "")){
                            ...
                            // jiashu 中的 创建时间 判空处理
                            // if('jiashu' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
                            ...
                            // }
                            // yonghu 中的 价钱 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuJaiwei== null ||this.ruleForm.yonghuJaiwei== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/yanglaoyaunguanlixitong/img/back-img-bg.jpg);
