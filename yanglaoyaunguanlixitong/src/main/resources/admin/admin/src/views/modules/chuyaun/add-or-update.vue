    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="chuyaunUuidNumber">
                       <el-input v-model="ruleForm.chuyaunUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.chuyaunUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="chuyaunUuidNumber">
                           <el-input v-model="ruleForm.chuyaunUuidNumber"
            ...
            <input id="laorenId" name="laorenId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报名理由" prop="chuyaunText">
                        <el-input type="textarea"  :readonly="ro.chuyaunText" v-model="ruleForm.chuyaunText" placeholder="报名理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chuyaunText" label="报名理由" prop="chuyaunText">
                            <span v-html="ruleForm.chuyaunText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.chuyaunYesnoTypes" label="报名状态" prop="chuyaunYesnoTypes">
                        <el-input v-model="ruleForm.chuyaunYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.chuyaunYesnoText" label="审核回复" prop="chuyaunYesnoText">
                        <span v-html="ruleForm.chuyaunYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.chuyaunShenheTime" label="审核时间" prop="chuyaunShenheTime">
                        <span v-html="ruleForm.chuyaunShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    chuyaunUuidNumber: new Date().getTime(),
                    jiashuId: '',
                    laorenId: '',
                    chuyaunText: '',
                    insertTime: '',
                ...
                rules: {
                   ...
                   insertTime: [
                              { required: true, message: '出院申请时间不能为空', trigger: 'blur' },
                          ],
                   chuyaunYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chuyaun_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chuyaunYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`chuyaun/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chuyaunCrossAddOrUpdateFlag = false;
                                        this.parent.search();
