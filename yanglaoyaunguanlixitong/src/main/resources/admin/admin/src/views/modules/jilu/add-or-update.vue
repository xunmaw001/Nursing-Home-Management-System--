    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laorenId" name="laorenId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="记录名称" prop="jiluName">
                       <el-input v-model="ruleForm.jiluName"
                                 placeholder="记录名称" clearable  :readonly="ro.jiluName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="记录名称" prop="jiluName">
                           <el-input v-model="ruleForm.jiluName"
                                     placeholder="记录名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="记录编号" prop="jiluUuidNumber">
                       <el-input v-model="ruleForm.jiluUuidNumber"
                                 placeholder="记录编号" clearable  :readonly="ro.jiluUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="记录编号" prop="jiluUuidNumber">
                           <el-input v-model="ruleForm.jiluUuidNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiluPhoto" label="记录照片" prop="jiluPhoto">
                        <file-upload
                            tip="点击上传记录照片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.jiluPhoto?$base.url+ruleForm.jiluPhoto:''"
                            @change="jiluPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiluPhoto" label="记录照片" prop="jiluPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.jiluPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="体温" prop="jiluTiwen">
                       <el-input v-model="ruleForm.jiluTiwen"
                                 placeholder="体温" clearable  :readonly="ro.jiluTiwen"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="体温" prop="jiluTiwen">
                           <el-input v-model="ruleForm.jiluTiwen"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="血压" prop="jiluXueya">
                       <el-input v-model="ruleForm.jiluXueya"
                                 placeholder="血压" clearable  :readonly="ro.jiluXueya"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="血压" prop="jiluXueya">
                           <el-input v-model="ruleForm.jiluXueya"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.jiluContent"  label="健康介绍" prop="jiluContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiluContent" label="健康介绍" prop="jiluContent">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   yonghuId: [
                              { required: true, message: '护工不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   jiluPhoto: [
                              { required: true, message: '记录照片不能为空', trigger: 'blur' },
                          ],
                   jiluTiwen: [
                   ...
                   jiluContent: [
                              { required: true, message: '健康介绍不能为空', trigger: 'blur' },
                          ],
                   jiluDelete: [
        ...
        methods: {
            ...
            //图片
            jiluPhotoUploadChange(fileUrls){
                this.ruleForm.jiluPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
