        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '记录名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.jiluName" placeholder="记录名称" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yanglaoyaunguanlixitong/upload/jiluMuBan.xls"
                        >批量导入健康信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('jilu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="jiluPhoto"
                                     header-align="center"
                                     width="200"
                                     label="记录照片">
                        <template slot-scope="scope">
                            <div v-if="scope.row.jiluPhoto">
                                <img :src="$base.url+scope.row.jiluPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
            ...
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        ...
                        string : 'jilu_xueya',//分组字符串字段
                        // types : 'jilu_types',//分组下拉框字段
                    },
                    joinTable : {//级联表（可以不存在）
                        tableName :'laoren',//级联表表名
                        // date : 'insert_time',//分组日期字段
