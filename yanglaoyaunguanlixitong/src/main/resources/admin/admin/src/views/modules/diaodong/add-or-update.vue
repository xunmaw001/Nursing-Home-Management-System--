    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="diaodongUuidNumber">
                       <el-input v-model="ruleForm.diaodongUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.diaodongUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="diaodongUuidNumber">
                           <el-input v-model="ruleForm.diaodongUuidNumber"
            ...
            <input id="chuangweiId" name="chuangweiId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报名理由" prop="diaodongText">
                        <el-input type="textarea"  :readonly="ro.diaodongText" v-model="ruleForm.diaodongText" placeholder="报名理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.diaodongText" label="报名理由" prop="diaodongText">
                            <span v-html="ruleForm.diaodongText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.diaodongYesnoTypes" label="报名状态" prop="diaodongYesnoTypes">
                        <el-input v-model="ruleForm.diaodongYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.diaodongYesnoText" label="审核回复" prop="diaodongYesnoText">
                        <span v-html="ruleForm.diaodongYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.diaodongShenheTime" label="审核时间" prop="diaodongShenheTime">
                        <span v-html="ruleForm.diaodongShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    diaodongUuidNumber: new Date().getTime(),
                    jiashuId: '',
                    laorenId: '',
                    chuangweiId: '',
                    diaodongText: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=diaodong_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.diaodongYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`diaodong/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.diaodongCrossAddOrUpdateFlag = false;
                                        this.parent.search();
