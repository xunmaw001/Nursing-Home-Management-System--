	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        <view class="search-form round">
				<input :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"16rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
						v-model="searchForm.yonghuName" type="text" placeholder="护工姓名"></input>
		</view>
            ...
            <view class="list b-b" v-for="(item, index) in list" :key="index" style="width:100%;height: auto;border: 1rps solid #999;margin: 0 auto;background-color: #FFFFFF;margin-top: 10rpx; box-shadow: 0  0 10rpx 0 #999999;border-radius: 25rpx;">
                <view
                 ...
                 <view v-show="item.yonghuUuidNumber" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">护工编号</text>
                 ...
                 <view v-show="item.yonghuPhone" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">护工手机号</text>
                 ...
                 <view v-show="item.yonghuIdNumber" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">护工身份证号</text>
                 ...
                 <view v-show="item.yonghuValue" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">护工等级</text>
                     <text style="width: 70%">{{item.yonghuValue}}</text>
                 </view>
                 <view v-show="item.yonghuJaiwei" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">价钱</text>
                     <text style="width: 70%">{{item.yonghuJaiwei}}</text>
                 </view>
                 <view v-show="item.yonghuEmail" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">护工邮箱</text>
...
<script>
	export default {
		...
		async onShow() {
			...
			yonghuTypes.data.list.splice(0, 0, {codeIndex: 0, indexName: '全部'})
            this.categoryList = yonghuTypes.data.list
