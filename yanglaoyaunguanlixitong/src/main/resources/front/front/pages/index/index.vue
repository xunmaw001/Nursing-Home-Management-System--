...
<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;" :style='{"backgroundColor":"var(--publicSubColor)","borderColor":"var(--publicMainColor)","color":"rgba(255, 255, 255, 1)","borderRadius":"200rpx","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"dashed"}'>
    ...
    <view class="right-content" @tap="onPageTap('chuangwei')" :style="{fontSize:'32rpx',color:'#FFF'}">
        查看更多
    </view>
</view>
<view class="list-box style4"
    ...
    <view class="list-item">
        <view v-if="chuangweiList.length > 0"
              @tap="onDetailTap('chuangwei',chuangweiList[0].id)" class="box box1"
            ...
            <div
                    ...
                    class="title hide1">{{chuangweiList[0].chuangweiName}}
            </div>
            <image
                    ...
                    :src="baseUrl+chuangweiList[0].chuangweiPhoto">
            </image>
        </view>
        <view class="list-item-body" style="flex: 1;">
            <view v-if="chuangweiList.length > 1"
                  @tap="onDetailTap('chuangwei',chuangweiList[1].id)" class="box box2"
                ...
                <div
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                        class="title hide1">{{chuangweiList[1].chuangweiName}}
                </div>
                <image
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                        class="list-item-image" mode="aspectFill"
                        :src="baseUrl+chuangweiList[1].chuangweiPhoto">
                </image>
            </view>
            <view v-if="chuangweiList.length > 2"
                  @tap="onDetailTap('chuangwei',chuangweiList[2].id)" class="box box3"
                ...
                <div
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                        class="title hide1">{{chuangweiList[2].chuangweiName}}
                </div>
                <image
                        :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                        class="list-item-image" mode="aspectFill"
                        :src="baseUrl+chuangweiList[2].chuangweiPhoto">
                </image>
            </view>
        </view>
    </view>
    <view class="list-item">
        <view v-if="chuangweiList.length > 3"
              @tap="onDetailTap('chuangwei',chuangweiList[3].id)" class="box box4"
            ...
            <div
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="title hide1">{{chuangweiList[3].chuangweiName}}
            </div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+chuangweiList[3].chuangweiPhoto">
            </image>
        </view>
        <view v-if="chuangweiList.length > 4"
              @tap="onDetailTap('chuangwei',chuangweiList[4].id)" class="box box5"
            ...
            <div
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                    class="title hide1">{{chuangweiList[4].chuangweiName}}
            </div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+chuangweiList[4].chuangweiPhoto">
            </image>
        </view>
    </view>
    <view v-if="chuangweiList.length > 5"
          @tap="onDetailTap('chuangwei',chuangweiList[5].id)" class="box box6"
        ...
        <div
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                class="title hide1">{{chuangweiList[5].chuangweiName}}
        </div>
        <image
                :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"var(--publicSubColor)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"8rpx","width":"100%","borderStyle":"solid","height":"100%"}'
                class="list-item-image" mode="aspectFill"
                :src="baseUrl+chuangweiList[5].chuangweiPhoto">
        </image>
    </view>
</view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let chuangwei = await this.$api.list('chuangwei', {
                page: 1,
                limit: 6,
                });

            this.chuangweiList = chuangwei.data.list
            this.chuangweiList.forEach(function(item, index) {
