	...
	<script>
		export default {
			...
			async onLoad(options) {
				this.chuangweiYuyueId = options.id;
			},
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.detail('chuangweiYuyue', this.chuangweiYuyueId);
                    this.detail = res.data
					// 主图
					this.swiperList = this.detail.chuangweiYuyuePhoto ? this.detail.chuangweiYuyuePhoto.split(",") : [];
				},
				...
				async baoming() {
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
								await _this.$api.add('chuangweiYuyueYuyue', {
