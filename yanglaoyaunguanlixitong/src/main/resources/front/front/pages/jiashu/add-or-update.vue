    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">家属编号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"16rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiashuUuidNumber" type="text" v-model="ruleForm.jiashuUuidNumber" placeholder="家属编号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">家属姓名</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"16rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiashuName" type="text" v-model="ruleForm.jiashuName" placeholder="家属姓名"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">家属手机号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"16rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiashuPhone" type="text" v-model="ruleForm.jiashuPhone" placeholder="家属手机号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">家属身份证号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"16rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiashuIdNumber" type="text" v-model="ruleForm.jiashuIdNumber" placeholder="家属身份证号"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="jiashuPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">家属头像</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.jiashuPhoto" :src="baseUrl+ruleForm.jiashuPhoto" mode="aspectFill">
                        </image>
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">家属邮箱</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"16rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.jiashuEmail" type="text" v-model="ruleForm.jiashuEmail" placeholder="家属邮箱"></input>
            </view>
    ...
    export default {
        data() {
            ...
            ruleForm: {
					username: '',
					password: '',
					jiashuUuidNumber: this.getUUID(),//数字
					jiashuName: '',
					jiashuPhone: '',
					jiashuIdNumber: '',
					jiashuPhoto: '',
		...
		/*下拉框*/
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`jiashu`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.jiashuId){
                this.ruleForm.jiashuId = options.jiashuId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.jiashuUuidNumber)) {
                    this.$utils.msg(`家属编号不能为空`);
                    return
                }
				if ((!this.ruleForm.jiashuName)) {
                    this.$utils.msg(`家属姓名不能为空`);
                    return
                }
				if ((!this.ruleForm.jiashuPhone) && (!this.$validate.isMobile(this.ruleForm.jiashuPhone))) {
                    this.$utils.msg(`家属手机号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.jiashuIdNumber) && (!this.$validate.checkIdCard(this.ruleForm.jiashuIdNumber))) {
                    this.$utils.msg(`家属身份证号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.jiashuPhoto)) {
                    this.$utils.msg(`家属头像不能为空`);
                    return
                }
				...
				if ((!this.ruleForm.jiashuEmail) && (!this.$validate.isEmail(this.ruleForm.jiashuEmail))) {
                    this.$utils.msg(`家属邮箱不能为空并且需要输入正确格式`);
                    return
                }
                if (this.ruleForm.id) {
                    await this.$api.update(`jiashu`, this.ruleForm);
                } else {
                    await this.$api.save(`jiashu`, this.ruleForm);
                }
