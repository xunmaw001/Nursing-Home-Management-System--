...
//                            yonghuEntity.setYonghuUuidNumber(data.get(0));                    //护工编号 要改的
//                            yonghuEntity.setYonghuName(data.get(0));                    //护工姓名 要改的
//                            yonghuEntity.setYonghuPhone(data.get(0));                    //护工手机号 要改的
//                            yonghuEntity.setYonghuIdNumber(data.get(0));                    //护工身份证号 要改的
//                            yonghuEntity.setYonghuPhoto("");//详情和图片
//                            yonghuEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            yonghuEntity.setYonghuTypes(Integer.valueOf(data.get(0)));   //护工等级 要改的
//                            yonghuEntity.setYonghuJaiwei(data.get(0));                    //价钱 要改的
//                            yonghuEntity.setYonghuEmail(data.get(0));                    //护工邮箱 要改的
...
//                            yonghuEntity.setCreateTime(date);//时间
                        ...
                        if(yonghuEntities_yonghuUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [护工编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //护工手机号
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "护工");
        R r = R.ok();
        r.put("token", token);
        r.put("role","护工");
