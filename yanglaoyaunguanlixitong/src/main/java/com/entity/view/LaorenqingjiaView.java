...
public class LaorenqingjiaView extends LaorenqingjiaEntity implements Serializable {
	...
	*/
	...
	private String laorenqingjiaYesnoValue;
	...
	* 获取： 报名状态的值
	*/
	public String getLaorenqingjiaYesnoValue() {
		return laorenqingjiaYesnoValue;
	}
	/**
	* 设置： 报名状态的值
	*/
	public void setLaorenqingjiaYesnoValue(String laorenqingjiaYesnoValue) {
		this.laorenqingjiaYesnoValue = laorenqingjiaYesnoValue;
	}
	...
	public String toString() {
		return "LaorenqingjiaView{" +
			", laorenqingjiaYesnoValue=" + laorenqingjiaYesnoValue +
