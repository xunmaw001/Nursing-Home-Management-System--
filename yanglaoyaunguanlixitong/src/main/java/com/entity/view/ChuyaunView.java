...
*/
@TableName("chuyaun")
public class ChuyaunView extends ChuyaunEntity implements Serializable {
	...
	*/
	...
	private String chuyaunYesnoValue;
	...
	public ChuyaunView(ChuyaunEntity chuyaunEntity) {
		try {
			BeanUtils.copyProperties(this, chuyaunEntity);
	...
	* 获取： 报名状态的值
	*/
	public String getChuyaunYesnoValue() {
		return chuyaunYesnoValue;
	}
	/**
	* 设置： 报名状态的值
	*/
	public void setChuyaunYesnoValue(String chuyaunYesnoValue) {
		this.chuyaunYesnoValue = chuyaunYesnoValue;
	}
	...
	public String toString() {
		return "ChuyaunView{" +
			", chuyaunYesnoValue=" + chuyaunYesnoValue +
